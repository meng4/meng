...
<head>
    ...
    <link href="admin/lib/font-awesome-4.7.0/css/font-awesome.css" rel="stylesheet" />
    <link href="admin/lib/winui/css/winui.css" rel="stylesheet" />
    <script>
    ...
    <style>
        body {
            ...
            background-image: url(admin/images/bg_01.jpg);
        }
    </style>
</head>
<body>
                ...
                <div class="winui-nav-tile">
                    ...
                    <div class="winui-tilebox">
                        ...
                        <div class="winui-tilebox-body">
                            ...
                            <div class="winui-tile winui-tile-normal">
                                <img src="admin/images/logo_100.png" />
                                <span>自定义图片</span>
                            </div>
                            <div class="winui-tile winui-tile-normal">
                                <i class="fa fa-file-text"></i>
                            ...
                            <div class="winui-tile winui-tile-normal">
                                <img src="admin/images/qzone_32.png" />
                                <span>QQ空间</span>
                            </div>
                            <div class="winui-tile winui-tile-normal">
